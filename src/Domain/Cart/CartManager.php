...
use Domain\Cart\StorageIdentities\FakeIdentitiesStorage;
...
final class CartManager
{
    public function __construct(
        protected CartIdentityStorage $identityStorage
    ){
    }

    public static function fake(): void
    {
        app()->bind(CartIdentityStorage::class, FakeIdentitiesStorage::class);
    }
    ...
    public function items(): Collection
    {
        ...
        return CartItem::query()
            ...
            ->whereBelongsTo($this->getCurrentCart())
            ->get();
    }
