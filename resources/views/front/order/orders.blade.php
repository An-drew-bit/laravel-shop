     ...
     <main class="py-16 lg:py-20">
         <div class="container">
            ...
            <section>
                ...
                @if($orders->isEmpty())
                    <div class="py-3 px-6 rounded-lg bg-pink text-white">У вас еще нет сформированных заказов</div>
                @else
                                ...
                                <div class="py-4">
                                    <div class="flex gap-6">
                                        <div class="shrink-0 overflow-hidden w-[64px] sm:w-[84px] h-[64px] sm:h-[84px] rounded-2xl">
                                            <img src="./images/products/1.jpg" class="object-cover w-full h-full" alt="Заказ №{{ $order->id }}">
                                        </div>
                                        <div class="grow py-2">
                                            <div class="flex flex-col md:flex-row md:items-center gap-2">
                                                ...
                                                <div class="px-3 py-1 rounded-md bg-purple text-xxs">{{ $order->status->uiValue() }}</div>
