<div class="product-card flex flex-col md:flex-row rounded-3xl bg-card">
    ...
    <div class="grow flex flex-col py-8 px-6 md:px-8">
        <h3 class="text-sm lg:text-md font-black"><a href="{{ route('product', $product) }}" class="inline-block text-white hover:text-pink">SteelSeries Aerox 3 Snow</a></h3>
        ...
        <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6 mt-6">
            ...
            <div class="flex flex-wrap items-center gap-4">
                <a href="{{ route('cart.add', $product) }}" class="w-[56px] !h-[56px] !px-0 btn btn-pink">
